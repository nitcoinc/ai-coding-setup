---
description: Manual PreCompact — write a checkpoint to PROJECT.md before context fills or before starting a new thread.
---

Update `PROJECT.md` now. Use the Edit tool.
...
4. Confirm: `PROJECT.md checkpointed at <timestamp>. Safe to start a new thread.`
