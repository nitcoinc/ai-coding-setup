...
## workflow aliases
Codex prompts are copied globally to `~/.codex/prompts/`: `/onboard`, `/spec`, `/feature`, `/implement`, `/incident`, `/performance`, `/ui`, `/security`, `/dependency-update`, `/release`, `/refactor`, `/review`, `/testplan`, `/freshcheck`, `/pressuretest`, `/goodpractices`.
